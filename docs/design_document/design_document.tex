...
Given a movie id, return all movie details. Snippet not reported for brevity's sake.
...
A rating can be added, read, updated or deleted. Related snippets are not shown for brevity's sake.
