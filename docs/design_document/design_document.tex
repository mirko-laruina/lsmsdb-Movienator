...
\paragraph{Indices} 
\begin{itemize}
	\item \emph{movie\_id}: speed up aggregations.
	\item \emph{(user\_id, movie\_id}: quickly find user's ratings (compound index).
\end{itemize}
...
\end{figure}
%TODO change architecture to highlight periodic scripts
